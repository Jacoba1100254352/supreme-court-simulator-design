...
The manuscript figures are regenerated by `make paper` from `reports/constitutional-review-campaign-v2.csv` through `paper/scripts/generate_figures.py`.
The manuscript's local JLC-format guardrail is `make paper-check`.
