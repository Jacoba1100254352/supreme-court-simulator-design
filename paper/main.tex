...
The simulator, normalized calibration tables, deterministic seeds, scenario definitions, generated reports, and figure-generation scripts are maintained as a reproducible project. Public repository identifiers are withheld in this anonymous review manuscript. The intended replication package includes source code, build instructions, normalized input data, generated campaign artifacts, generated figure fragments, and documentation distinguishing observed inputs, coding choices, model assumptions, and simulated outputs.
