...
P_{is} = \mathrm{clamp}_{[0,1]}(&b_{\mathrm{petition}}
 ...
 + .06\,\mathrm{SG}_i \\
&+ .06\,\mathrm{splitDepth}_i
 + .04\,\mathrm{repeatPlayer}_i
 + .04\,\mathrm{plaintiffSelection}_i
