...
SELECTED_SCENARIOS = [
    ("current-us-like", "CUR"),
    ("term-limited-balanced", "TERM"),
    ("emergency-restraint-court", "EMERG"),
    ("nonpartisan-commission", "COMM"),
    ("supermajority-review", "S60"),
    ("panel-en-banc", "PANEL"),
    ("comparative-constitutional-senates", "SENATE"),
    ("cross-checking-courts", "CHECK"),
]
