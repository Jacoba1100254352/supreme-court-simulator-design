...
def write_conflict_confidence_tradeoff(averages: dict[str, dict[str, float]]) -> None:
    ...
    label_positions = {
        "current-us-like": (51.5, 28.0, "r"),
        "term-limited-balanced": (39.5, 54.5, "r"),
        "emergency-restraint-court": (51.2, 67.0, "l"),
        "nonpartisan-commission": (58.5, 55.0, "l"),
        "supermajority-review": (39.2, 42.5, "r"),
        "panel-en-banc": (60.5, 61.8, "l"),
        "comparative-constitutional-senates": (38.4, 63.6, "r"),
        "cross-checking-courts": (97.5, 57.6, "c"),
    }
    lines = [
...
def write_selected_campaign_table(averages: dict[str, dict[str, float]]) -> None:
    selected = [
        ...
        ("nonpartisan-commission", "Nonpartisan commission"),
        ("emergency-restraint-court", "No emergency relief without merits review"),
        ("supermajority-review", "60 percent invalidation threshold"),
        ("panel-en-banc", "Panel with en banc correction"),
        ("comparative-constitutional-senates", "Comparative 16-seat constitutional senates"),
        ("cross-checking-courts", "Cross-checking constitutional court"),
    ]
    fields = [
        "admissionRate",
        "rightsProtection",
