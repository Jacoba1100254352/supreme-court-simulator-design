...
- source observations: 982

## Summary

- targets within assigned ranges: 23 / 23
- guardrail-use counts: strict_validation=4, model_prior_check=2, loose_calibration=11, proxy_sanity_check=4, mechanism_sanity_check=2
...
| `scotus-certiorari-docketed-cohort-ot2023` | [Official Supreme Court OT2023 paid/IFP docketed-intake cohort](https://www.supremecourt.gov/docket/docket.aspx) | Enumerates all 4,222 paid and IFP dockets in the official OT2023 Journal statistics window and codes petition-level CFR and CVSG stages. |
| `scotus-certiorari-docketed-cohort-ot2024` | [Official Supreme Court OT2024 published-statistics paid/IFP docketed-intake cohort](https://www.supremecourt.gov/docket/docket.aspx) | Enumerates the 3,854 paid and IFP dockets in the published OT2024 Journal statistics snapshot and codes the same petition-level stages as OT2023; same-cutoff-date dockets above the count-defined ranges are disclosed separately in the cohort manifest. |
...
| Declarations of unconstitutionality should be uncommon in the full merits docket. | Stylized current U.S.-like supreme court | `strict_validation` | `raw_or_primary_summary` | `invalidationRate` | `invalidationRate` | 0.090 | 0.000-0.223 | 0.066 | 79 | 1946-2024 | within range |
| Admissibility-aware current-like designs should transfer a substantial but not universal share of filed matters to merits. | Stylized current U.S.-like supreme court | `model_prior_check` | `research_synthesis` | `meritsTransferRate` | `admissibilityModelShare` | 0.390 | 0.250-0.850 | 0.550 | 0 |  | within range |
| Paid certiorari petitions should be a minority of cert-style intake after the paid/IFP denominator is separated from all filed matters. | Stylized current U.S.-like supreme court | `loose_calibration` | `raw_or_primary_summary` | `paidCertPetitionShare` | `paidPetitionShare` | 0.311 | 0.246-0.424 | 0.335 | 2 | OT2023-OT2024 | within range |
| IFP certiorari petitions should be the majority of cert-style intake after the paid/IFP denominator is separated from all filed matters. | Stylized current U.S.-like supreme court | `loose_calibration` | `raw_or_primary_summary` | `ifpCertPetitionShare` | `ifpPetitionShare` | 0.689 | 0.576-0.754 | 0.665 | 2 | OT2023-OT2024 | within range |
| Paid cert-style petitions should expose a separate court-requested-response stage rather than a one-step grant draw. | Stylized current U.S.-like supreme court | `loose_calibration` | `raw_or_primary_summary` | `paidCfrRequestRate` | `cfrRate_paid` | 0.045 | 0.022-0.171 | 0.126 | 3 | OT2001–OT2004-OT2024 | within range |
| IFP cert-style petitions should expose a lower-frequency court-requested-response stage. | Stylized current U.S.-like supreme court | `loose_calibration` | `raw_or_primary_summary` | `ifpCfrRequestRate` | `cfrRate_ifp` | 0.039 | 0.000-0.051 | 0.026 | 3 | OT2001–OT2004-OT2024 | within range |
| CVSG requests should remain a rare petition-level transition within the certiorari pathway. | Stylized current U.S.-like supreme court | `loose_calibration` | `raw_or_primary_summary` | `cvsgRequestRate` | `cvsgRequestRate` | 0.001 | 0.000-0.020 | 0.004 | 2 | OT2023-OT2024 | within range |
...
| Emergency orders should be observable but not universal. | Stylized current U.S.-like supreme court | `loose_calibration` | `raw_or_primary_summary` | `emergencyOrderRate` | `emergencyOrderRate` | 0.338 | 0.000-0.773 | 0.100 | 22 | 2003-2024 | within range |
...
| Open emergency procedure creates measurable but bounded shadow-docket abuse. | Stylized current U.S.-like supreme court | `loose_calibration` | `raw_or_primary_summary` | `shadowDocketAbuse` | `shadowDocketAbuse` | 0.209 | 0.000-0.657 | 0.222 | 22 | 2003-2024 | within range |
| Precedent stability remains high enough for a stress-inclusive docket with screened and emergency matters. | Stylized current U.S.-like supreme court | `loose_calibration` | `raw_or_primary_summary` | `precedentStability` | `precedentStability` | 0.761 | 0.753-1.000 | 0.983 | 79 | 1946-2024 | within range |
| Statutory stability remains in a source-derived post-review band. | Stylized current U.S.-like supreme court | `loose_calibration` | `raw_or_primary_summary` | `statutoryStability` | `statutoryStability` | 0.680 | 0.627-1.000 | 0.934 | 79 | 1946-2024 | within range |
| Interbranch compliance stays above a low-conflict floor. | Stylized current U.S.-like supreme court | `proxy_sanity_check` | `raw_or_primary_summary` | `interbranchCompliance` | `statutoryStability` | 0.545 | 0.427-1.000 | 0.934 | 79 | 1946-2024 | within range |
...
| Override designs should produce observable but not constant override attempts. | Judicial review with legislative supermajority override | `proxy_sanity_check` | `raw_or_primary_summary` | `overrideAttemptRate` | `invalidationRate` | 0.075 | 0.000-0.333 | 0.066 | 79 | 1946-2024 | within range |
