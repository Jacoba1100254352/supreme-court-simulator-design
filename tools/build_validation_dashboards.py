...
def build_metric_semantics_rows(dashboard_rows: list[dict[str, str]]) -> list[dict[str, str]]:
    ...
    rows.extend([
        ...
        },
        {
            ...
            "empiricalUse": "synthetic_output",
            "denominatorCompatibility": "not_empirical_target",
            "manuscriptInterpretation": "legacy CSV name for the modeled public-legitimacy proxy; not a survey-estimated confidence level",
        },
        {
            "metricFamily": "headline",
            "metric": "processLegitimacyProxy",
            "sourceMetric": "",
            "simulatorDenominatorOrScale": "paper-facing alias for publicConfidence, constructed from process visibility, emergency legitimacy, partisan alignment, and strategic response",
            "sourceDenominatorOrScale": "none",
            "empiricalUse": "synthetic_output",
            "denominatorCompatibility": "not_empirical_target",
            "manuscriptInterpretation": "modeled process-legitimacy proxy, not public-opinion measurement",
        },
        {
            "metricFamily": "headline",
            "metric": "emergencyProcessIrregularity",
            "sourceMetric": "",
            "simulatorDenominatorOrScale": "paper-facing alias for shadowDocketAbuse, constructed from emergency opacity, missing merits follow-through, emergency opportunism, and merits-like relief",
            "sourceDenominatorOrScale": "none",
            "empiricalUse": "synthetic_output",
            "denominatorCompatibility": "not_empirical_target",
